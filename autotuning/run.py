...
target0_addr = config.get('hw_server','target0_addr')
target0_port = config.get('hw_server','target0_port')
server1_addr = config.get('hw_server','server1_addr')
server1_port = config.get('hw_server','server1_port')
target1_addr = config.get('hw_server','target1_addr')
target1_port = config.get('hw_server','target1_port')
...
rcv = pyIBERT(server0_addr,server0_port,target0_addr,target0_port)
print("Creating Instance 1")
transm = pyIBERT(server1_addr,server1_port,target1_addr,target1_port)
